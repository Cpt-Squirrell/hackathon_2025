...
function StartGame(request, response) {
	...
	console.log(`${request.ip} [${datetime.toLocaleDateString()} ${datetime.toLocaleTimeString()}]: ${location}: ${role} (Spy: ${spy})`);
    ...
    return response.json({
    	...
    	"game": new String(lobbyID).slice(0, 5)
    });
}